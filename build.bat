...
g++ -IC:\SFML-2.6.1\include -c "source_files/Board.cpp" -o "object_files/Board.o"
...
g++ -LC:\SFML-2.6.1\lib "object_files\main.o" "object_files\Game.o" "object_files\State.o" "object_files\MatchState.o" "object_files\Board.o" "object_files/Piece.o" "object_files/Pawn.o" "object_files/Knight.o" -o "executable_files\Chess.exe" -lmingw32 -lsfml-graphics -lsfml-window -lsfml-system -lsfml-main -mwindows
